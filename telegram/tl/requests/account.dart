...
List<int> otherUids = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(813089983,4),readBufferFromBigInt(this.tokenType,4,little:true,signed:true),serializeBytes(this.token),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.otherUids.length,4,little:true,signed:true),this.otherUids.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class UpdateNotifySettings {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2227067795,4),this.peer.getBytes(),this.settings.getBytes(),].expand((element) => element).toList();}
...
class GetNotifySettings {
	...
	List<int> getBytes(){return [readBufferFromBigInt(313765169,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
class UpdateProfile {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2018596725,4),[0,0,0,0],(this.firstName==null||this.firstName==false)?[]:[serializeBytes(this.firstName)],(this.lastName==null||this.lastName==false)?[]:[serializeBytes(this.lastName)],(this.about==null||this.about==false)?[]:[serializeBytes(this.about)],].expand((element) => element).toList();}
...
class ReportPeer {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2920848735,4),this.peer.getBytes(),this.reason.getBytes(),].expand((element) => element).toList();}
...
class GetPrivacy {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3671837008,4),this.key.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> rules = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3388480744,4),this.key.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.rules.length,4,little:true,signed:true),this.rules.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class SetAccountTTL {
	...
	List<int> getBytes(){return [readBufferFromBigInt(608323678,4),this.ttl.getBytes(),].expand((element) => element).toList();}
...
class SendChangePhoneCode {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2186758885,4),serializeBytes(this.phoneNumber),this.settings.getBytes(),].expand((element) => element).toList();}
...
class GetPasswordSettings {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2631199481,4),this.password.getBytes(),].expand((element) => element).toList();}
...
class UpdatePasswordSettings {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2778402863,4),this.password.getBytes(),this.newSettings.getBytes(),].expand((element) => element).toList();}
...
class SendConfirmPhoneCode {
	...
	List<int> getBytes(){return [readBufferFromBigInt(457157256,4),serializeBytes(this.hash),this.settings.getBytes(),].expand((element) => element).toList();}
...
class GetTmpPassword {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1151208273,4),this.password.getBytes(),readBufferFromBigInt(this.period,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> types = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1936088002,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.types.length,4,little:true,signed:true),this.types.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class SaveSecureValue {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2308956957,4),this.value.getBytes(),readBufferFromBigInt(this.secureSecretId,8,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> types = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3095444555,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.types.length,4,little:true,signed:true),this.types.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<dynamic> valueHashes = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3875699860,4),readBufferFromBigInt(this.botId,4,little:true,signed:true),serializeBytes(this.scope),serializeBytes(this.publicKey),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.valueHashes.length,4,little:true,signed:true),this.valueHashes.map((x)=>x.getBytes()),this.credentials.getBytes(),].expand((element) => element).toList();}
...
class SendVerifyPhoneCode {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2778945273,4),serializeBytes(this.phoneNumber),this.settings.getBytes(),].expand((element) => element).toList();}
...
class InitTakeoutSession {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4032514052,4),[0,0,0,0],(this.fileMaxSize==null||this.fileMaxSize==false)?[]:[readBufferFromBigInt(this.fileMaxSize,4,little:true,signed:true)],].expand((element) => element).toList();}
...
class GetNotifyExceptions {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1398240377,4),[0,0,0,0],(this.peer==null||this.peer==false)?[]:[this.peer.getBytes()],].expand((element) => element).toList();}
...
class GetWallPaper {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4237155306,4),this.wallpaper.getBytes(),].expand((element) => element).toList();}
...
class UploadWallPaper {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3716494945,4),this.file.getBytes(),serializeBytes(this.mimeType),this.settings.getBytes(),].expand((element) => element).toList();}
...
class SaveWallPaper {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1817860919,4),this.wallpaper.getBytes(),this.unsave ? 0xb5757299 : 0x379779bc,this.settings.getBytes(),].expand((element) => element).toList();}
...
class InstallWallPaper {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4276967273,4),this.wallpaper.getBytes(),this.settings.getBytes(),].expand((element) => element).toList();}
...
class SaveAutoDownloadSettings {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1995661875,4),[0,0,0,0],this.settings.getBytes(),].expand((element) => element).toList();}
...
class UploadTheme {
	...
	List<int> getBytes(){return [readBufferFromBigInt(473805619,4),[0,0,0,0],this.file.getBytes(),(this.thumb==null||this.thumb==false)?[]:[this.thumb.getBytes()],serializeBytes(this.fileName),serializeBytes(this.mimeType),].expand((element) => element).toList();}
...
class CreateTheme {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2217919007,4),[0,0,0,0],serializeBytes(this.slug),serializeBytes(this.title),(this.document==null||this.document==false)?[]:[this.document.getBytes()],(this.settings==null||this.settings==false)?[]:[this.settings.getBytes()],].expand((element) => element).toList();}
...
class UpdateTheme {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1555261397,4),[0,0,0,0],serializeBytes(this.format),this.theme.getBytes(),(this.slug==null||this.slug==false)?[]:[serializeBytes(this.slug)],(this.title==null||this.title==false)?[]:[serializeBytes(this.title)],(this.document==null||this.document==false)?[]:[this.document.getBytes()],(this.settings==null||this.settings==false)?[]:[this.settings.getBytes()],].expand((element) => element).toList();}
...
class SaveTheme {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4065792108,4),this.theme.getBytes(),this.unsave ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class InstallTheme {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2061776695,4),[0,0,0,0],(this.format==null||this.format==false)?[]:[serializeBytes(this.format)],(this.theme==null||this.theme==false)?[]:[this.theme.getBytes()],].expand((element) => element).toList();}
...
class GetTheme {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2375906347,4),serializeBytes(this.format),this.theme.getBytes(),readBufferFromBigInt(this.documentId,8,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> wallpapers = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1705865692,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.wallpapers.length,4,little:true,signed:true),this.wallpapers.map((x)=>x.getBytes()),].expand((element) => element).toList();}
