...
List<dynamic> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1673946374,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class Search {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2249518952,4),[0,0,0,0],this.peer.getBytes(),serializeBytes(this.q),(this.fromId==null||this.fromId==false)?[]:[this.fromId.getBytes()],this.filter.getBytes(),readBufferFromBigInt(this.minDate,4,little:true,signed:true),readBufferFromBigInt(this.maxDate,4,little:true,signed:true),readBufferFromBigInt(this.offsetId,4,little:true,signed:true),readBufferFromBigInt(this.addOffset,4,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),readBufferFromBigInt(this.maxId,4,little:true,signed:true),readBufferFromBigInt(this.minId,4,little:true,signed:true),readBufferFromBigInt(this.hash,4,little:true,signed:true),].expand((element) => element).toList();}
...
class ReadHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(238054714,4),this.peer.getBytes(),readBufferFromBigInt(this.maxId,4,little:true,signed:true),].expand((element) => element).toList();}
...
class DeleteHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(469850889,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.maxId,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3851326930,4),[0,0,0,0],readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class SetTyping {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2743230032,4),this.peer.getBytes(),this.action.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> entities = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1376532592,4),[0,0,0,0],this.peer.getBytes(),(this.replyToMsgId==null||this.replyToMsgId==false)?[]:[readBufferFromBigInt(this.replyToMsgId,4,little:true,signed:true)],serializeBytes(this.message),readBufferFromBigInt(this.randomId,8,little:true,signed:true),(this.replyMarkup==null||this.replyMarkup==false)?[]:[this.replyMarkup.getBytes()],(this.entities==null||this.entities==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.entities.length,4,little:true,signed:true),this.entities.map((x)=>x.getBytes())],(this.scheduleDate==null||this.scheduleDate==false)?[]:[readBufferFromBigInt(this.scheduleDate,4,little:true,signed:true)],].expand((element) => element).toList();}
...
List<dynamic> entities = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(881978281,4),[0,0,0,0],this.peer.getBytes(),(this.replyToMsgId==null||this.replyToMsgId==false)?[]:[readBufferFromBigInt(this.replyToMsgId,4,little:true,signed:true)],this.media.getBytes(),serializeBytes(this.message),readBufferFromBigInt(this.randomId,8,little:true,signed:true),(this.replyMarkup==null||this.replyMarkup==false)?[]:[this.replyMarkup.getBytes()],(this.entities==null||this.entities==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.entities.length,4,little:true,signed:true),this.entities.map((x)=>x.getBytes())],(this.scheduleDate==null||this.scheduleDate==false)?[]:[readBufferFromBigInt(this.scheduleDate,4,little:true,signed:true)],].expand((element) => element).toList();}
...
List<BigInt> randomId = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3657360910,4),[0,0,0,0],this.fromPeer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.randomId.length,4,little:true,signed:true),this.randomId.map((x)=>readBufferFromBigInt(x,8,little:true,signed:true)),this.toPeer.getBytes(),(this.scheduleDate==null||this.scheduleDate==false)?[]:[readBufferFromBigInt(this.scheduleDate,4,little:true,signed:true)],].expand((element) => element).toList();}
...
class ReportSpam {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3474297563,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
class GetPeerSettings {
	...
	List<int> getBytes(){return [readBufferFromBigInt(913498268,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3179460184,4),this.peer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),this.reason.getBytes(),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1013621127,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class EditChatPhoto {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3394009560,4),readBufferFromBigInt(this.chatId,4,little:true,signed:true),this.photo.getBytes(),].expand((element) => element).toList();}
...
class AddChatUser {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4188056073,4),readBufferFromBigInt(this.chatId,4,little:true,signed:true),this.userId.getBytes(),readBufferFromBigInt(this.fwdLimit,4,little:true,signed:true),].expand((element) => element).toList();}
...
class DeleteChatUser {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3764461334,4),readBufferFromBigInt(this.chatId,4,little:true,signed:true),this.userId.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> users = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(164303470,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.users.length,4,little:true,signed:true),this.users.map((x)=>x.getBytes()),serializeBytes(this.title),].expand((element) => element).toList();}
...
class RequestEncryption {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4132286275,4),this.userId.getBytes(),readBufferFromBigInt(this.randomId,4,little:true,signed:true),serializeBytes(this.gA),].expand((element) => element).toList();}
...
class AcceptEncryption {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1035731989,4),this.peer.getBytes(),serializeBytes(this.gB),readBufferFromBigInt(this.keyFingerprint,8,little:true,signed:true),].expand((element) => element).toList();}
...
class SetEncryptedTyping {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2031374829,4),this.peer.getBytes(),this.typing ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class ReadEncryptedHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2135648522,4),this.peer.getBytes(),readBufferFromBigInt(this.maxDate,4,little:true,signed:true),].expand((element) => element).toList();}
...
class SendEncrypted {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2843174771,4),this.peer.getBytes(),readBufferFromBigInt(this.randomId,8,little:true,signed:true),serializeBytes(this.data),].expand((element) => element).toList();}
...
class SendEncryptedFile {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2593135462,4),this.peer.getBytes(),readBufferFromBigInt(this.randomId,8,little:true,signed:true),serializeBytes(this.data),this.file.getBytes(),].expand((element) => element).toList();}
...
class SendEncryptedService {
	...
	List<int> getBytes(){return [readBufferFromBigInt(852769188,4),this.peer.getBytes(),readBufferFromBigInt(this.randomId,8,little:true,signed:true),serializeBytes(this.data),].expand((element) => element).toList();}
...
class ReportEncryptedSpam {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1259113487,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(916930423,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
List<dynamic> entities = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(2338894028,4),[0,0,0,0],serializeBytes(this.message),(this.entities==null||this.entities==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.entities.length,4,little:true,signed:true),this.entities.map((x)=>x.getBytes())],].expand((element) => element).toList();}
...
class ExportChatInvite {
	...
	List<int> getBytes(){return [readBufferFromBigInt(234312524,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
class GetStickerSet {
	...
	List<int> getBytes(){return [readBufferFromBigInt(639215886,4),this.stickerset.getBytes(),].expand((element) => element).toList();}
...
class InstallStickerSet {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3348096096,4),this.stickerset.getBytes(),this.archived ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class UninstallStickerSet {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4184757726,4),this.stickerset.getBytes(),].expand((element) => element).toList();}
...
class StartBot {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3873403768,4),this.bot.getBytes(),this.peer.getBytes(),readBufferFromBigInt(this.randomId,8,little:true,signed:true),serializeBytes(this.startParam),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3301483869,4),this.peer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),this.increment ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class EditChatAdmin {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2850463534,4),readBufferFromBigInt(this.chatId,4,little:true,signed:true),this.userId.getBytes(),this.isAdmin ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class SearchGlobal {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3211928996,4),[0,0,0,0],(this.folderId==null||this.folderId==false)?[]:[readBufferFromBigInt(this.folderId,4,little:true,signed:true)],serializeBytes(this.q),readBufferFromBigInt(this.offsetRate,4,little:true,signed:true),this.offsetPeer.getBytes(),readBufferFromBigInt(this.offsetId,4,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<BigInt> order = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(2016638777,4),[0,0,0,0],readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.order.length,4,little:true,signed:true),this.order.map((x)=>readBufferFromBigInt(x,8,little:true,signed:true)),].expand((element) => element).toList();}
...
class SaveGif {
	...
	List<int> getBytes(){return [readBufferFromBigInt(846868683,4),this.id.getBytes(),this.unsave ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class GetInlineBotResults {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1364105629,4),[0,0,0,0],this.bot.getBytes(),this.peer.getBytes(),(this.geoPoint==null||this.geoPoint==false)?[]:[this.geoPoint.getBytes()],serializeBytes(this.query),serializeBytes(this.offset),].expand((element) => element).toList();}
...
List<dynamic> results = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3948847622,4),[0,0,0,0],readBufferFromBigInt(this.queryId,8,little:true,signed:true),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.results.length,4,little:true,signed:true),this.results.map((x)=>x.getBytes()),readBufferFromBigInt(this.cacheTime,4,little:true,signed:true),(this.nextOffset==null||this.nextOffset==false)?[]:[serializeBytes(this.nextOffset)],(this.switchPm==null||this.switchPm==false)?[]:[this.switchPm.getBytes()],].expand((element) => element).toList();}
...
class SendInlineBotResult {
	...
	List<int> getBytes(){return [readBufferFromBigInt(570955184,4),[0,0,0,0],this.peer.getBytes(),(this.replyToMsgId==null||this.replyToMsgId==false)?[]:[readBufferFromBigInt(this.replyToMsgId,4,little:true,signed:true)],readBufferFromBigInt(this.randomId,8,little:true,signed:true),readBufferFromBigInt(this.queryId,8,little:true,signed:true),serializeBytes(this.id),(this.scheduleDate==null||this.scheduleDate==false)?[]:[readBufferFromBigInt(this.scheduleDate,4,little:true,signed:true)],].expand((element) => element).toList();}
...
class GetMessageEditData {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4255550774,4),this.peer.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> entities = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1224152952,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),(this.message==null||this.message==false)?[]:[serializeBytes(this.message)],(this.media==null||this.media==false)?[]:[this.media.getBytes()],(this.replyMarkup==null||this.replyMarkup==false)?[]:[this.replyMarkup.getBytes()],(this.entities==null||this.entities==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.entities.length,4,little:true,signed:true),this.entities.map((x)=>x.getBytes())],(this.scheduleDate==null||this.scheduleDate==false)?[]:[readBufferFromBigInt(this.scheduleDate,4,little:true,signed:true)],].expand((element) => element).toList();}
...
List<dynamic> entities = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(2203418042,4),[0,0,0,0],this.id.getBytes(),(this.message==null||this.message==false)?[]:[serializeBytes(this.message)],(this.media==null||this.media==false)?[]:[this.media.getBytes()],(this.replyMarkup==null||this.replyMarkup==false)?[]:[this.replyMarkup.getBytes()],(this.entities==null||this.entities==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.entities.length,4,little:true,signed:true),this.entities.map((x)=>x.getBytes())],].expand((element) => element).toList();}
...
class GetBotCallbackAnswer {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2164957164,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.msgId,4,little:true,signed:true),(this.data==null||this.data==false)?[]:[serializeBytes(this.data)],].expand((element) => element).toList();}
...
class SetBotCallbackAnswer {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3582923530,4),[0,0,0,0],readBufferFromBigInt(this.queryId,8,little:true,signed:true),(this.message==null||this.message==false)?[]:[serializeBytes(this.message)],(this.url==null||this.url==false)?[]:[serializeBytes(this.url)],readBufferFromBigInt(this.cacheTime,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> peers = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3832593661,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.peers.length,4,little:true,signed:true),this.peers.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<dynamic> entities = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3157909835,4),[0,0,0,0],(this.replyToMsgId==null||this.replyToMsgId==false)?[]:[readBufferFromBigInt(this.replyToMsgId,4,little:true,signed:true)],this.peer.getBytes(),serializeBytes(this.message),(this.entities==null||this.entities==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.entities.length,4,little:true,signed:true),this.entities.map((x)=>x.getBytes())],].expand((element) => element).toList();}
...
List<BigInt> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1527873830,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,8,little:true,signed:true)),].expand((element) => element).toList();}
...
class SaveRecentSticker {
	...
	List<int> getBytes(){return [readBufferFromBigInt(958863608,4),[0,0,0,0],this.id.getBytes(),this.unsave ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class GetAttachedStickers {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3428542412,4),this.media.getBytes(),].expand((element) => element).toList();}
...
class SetGameScore {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2398678208,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),this.userId.getBytes(),readBufferFromBigInt(this.score,4,little:true,signed:true),].expand((element) => element).toList();}
...
class SetInlineGameScore {
	...
	List<int> getBytes(){return [readBufferFromBigInt(363700068,4),[0,0,0,0],this.id.getBytes(),this.userId.getBytes(),readBufferFromBigInt(this.score,4,little:true,signed:true),].expand((element) => element).toList();}
...
class GetGameHighScores {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3894568093,4),this.peer.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),this.userId.getBytes(),].expand((element) => element).toList();}
...
class GetInlineGameHighScores {
	...
	List<int> getBytes(){return [readBufferFromBigInt(258170395,4),this.id.getBytes(),this.userId.getBytes(),].expand((element) => element).toList();}
...
class GetCommonChats {
	...
	List<int> getBytes(){return [readBufferFromBigInt(218777796,4),this.userId.getBytes(),readBufferFromBigInt(this.maxId,4,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<int> exceptIds = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3953659888,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.exceptIds.length,4,little:true,signed:true),this.exceptIds.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class ToggleDialogPin {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2805064279,4),[0,0,0,0],this.peer.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> order = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(991616823,4),[0,0,0,0],readBufferFromBigInt(this.folderId,4,little:true,signed:true),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.order.length,4,little:true,signed:true),this.order.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<dynamic> shippingOptions = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3858133754,4),[0,0,0,0],readBufferFromBigInt(this.queryId,8,little:true,signed:true),(this.error==null||this.error==false)?[]:[serializeBytes(this.error)],(this.shippingOptions==null||this.shippingOptions==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.shippingOptions.length,4,little:true,signed:true),this.shippingOptions.map((x)=>x.getBytes())],].expand((element) => element).toList();}
...
class SetBotPrecheckoutResults {
	...
	List<int> getBytes(){return [readBufferFromBigInt(163765653,4),[0,0,0,0],readBufferFromBigInt(this.queryId,8,little:true,signed:true),(this.error==null||this.error==false)?[]:[serializeBytes(this.error)],].expand((element) => element).toList();}
...
class UploadMedia {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1369162417,4),this.peer.getBytes(),this.media.getBytes(),].expand((element) => element).toList();}
...
class SendScreenshotNotification {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3380473888,4),this.peer.getBytes(),readBufferFromBigInt(this.replyToMsgId,4,little:true,signed:true),readBufferFromBigInt(this.randomId,8,little:true,signed:true),].expand((element) => element).toList();}
...
class FaveSticker {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3120547163,4),this.id.getBytes(),this.unfave ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class GetUnreadMentions {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1180140658,4),this.peer.getBytes(),readBufferFromBigInt(this.offsetId,4,little:true,signed:true),readBufferFromBigInt(this.addOffset,4,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),readBufferFromBigInt(this.maxId,4,little:true,signed:true),readBufferFromBigInt(this.minId,4,little:true,signed:true),].expand((element) => element).toList();}
...
class ReadMentions {
	...
	List<int> getBytes(){return [readBufferFromBigInt(251759059,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
class GetRecentLocations {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3150207753,4),this.peer.getBytes(),readBufferFromBigInt(this.limit,4,little:true,signed:true),readBufferFromBigInt(this.hash,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> multiMedia = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3422621899,4),[0,0,0,0],this.peer.getBytes(),(this.replyToMsgId==null||this.replyToMsgId==false)?[]:[readBufferFromBigInt(this.replyToMsgId,4,little:true,signed:true)],readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.multiMedia.length,4,little:true,signed:true),this.multiMedia.map((x)=>x.getBytes()),(this.scheduleDate==null||this.scheduleDate==false)?[]:[readBufferFromBigInt(this.scheduleDate,4,little:true,signed:true)],].expand((element) => element).toList();}
...
class UploadEncryptedFile {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1347929239,4),this.peer.getBytes(),this.file.getBytes(),].expand((element) => element).toList();}
...
class MarkDialogUnread {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3263617423,4),[0,0,0,0],this.peer.getBytes(),].expand((element) => element).toList();}
...
class UpdatePinnedMessage {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3534419948,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<List<int>> options = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(283795844,4),this.peer.getBytes(),readBufferFromBigInt(this.msgId,4,little:true,signed:true),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.options.length,4,little:true,signed:true),this.options.map((x)=>serializeBytes(x)),].expand((element) => element).toList();}
...
class GetPollResults {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1941660731,4),this.peer.getBytes(),readBufferFromBigInt(this.msgId,4,little:true,signed:true),].expand((element) => element).toList();}
...
class GetOnlines {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1848369232,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
class GetStatsURL {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2167155430,4),[0,0,0,0],this.peer.getBytes(),serializeBytes(this.params),].expand((element) => element).toList();}
...
class EditChatAbout {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3740665751,4),this.peer.getBytes(),serializeBytes(this.about),].expand((element) => element).toList();}
...
class EditChatDefaultBannedRights {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2777049921,4),this.peer.getBytes(),this.bannedRights.getBytes(),].expand((element) => element).toList();}
...
List<String> langCodes = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1318675378,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.langCodes.length,4,little:true,signed:true),this.langCodes.map((x)=>serializeBytes(x)),].expand((element) => element).toList();}
...
List<dynamic> filters = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1932455680,4),this.peer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.filters.length,4,little:true,signed:true),this.filters.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class RequestUrlAuth {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3812578835,4),this.peer.getBytes(),readBufferFromBigInt(this.msgId,4,little:true,signed:true),readBufferFromBigInt(this.buttonId,4,little:true,signed:true),].expand((element) => element).toList();}
...
class AcceptUrlAuth {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4146719384,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.msgId,4,little:true,signed:true),readBufferFromBigInt(this.buttonId,4,little:true,signed:true),].expand((element) => element).toList();}
...
class HidePeerSettingsBar {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1336717624,4),this.peer.getBytes(),].expand((element) => element).toList();}
...
class GetScheduledHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3804391515,4),this.peer.getBytes(),readBufferFromBigInt(this.hash,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3183150180,4),this.peer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3174597898,4),this.peer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(1504586518,4),this.peer.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class GetPollVotes {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3094231054,4),[0,0,0,0],this.peer.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),(this.option==null||this.option==false)?[]:[serializeBytes(this.option)],(this.offset==null||this.offset==false)?[]:[serializeBytes(this.offset)],readBufferFromBigInt(this.limit,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<dynamic> stickersets = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3037016042,4),[0,0,0,0],readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.stickersets.length,4,little:true,signed:true),this.stickersets.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class UpdateDialogFilter {
	...
	List<int> getBytes(){return [readBufferFromBigInt(450142282,4),[0,0,0,0],readBufferFromBigInt(this.id,4,little:true,signed:true),(this.filter==null||this.filter==false)?[]:[this.filter.getBytes()],].expand((element) => element).toList();}
...
List<int> order = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3311649252,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.order.length,4,little:true,signed:true),this.order.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
