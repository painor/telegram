...
List<dynamic> users = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(4117684904,4),readBufferFromBigInt(this.count,4,little:true,signed:true),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.participants.length,4,little:true,signed:true),this.participants.map((x)=>x.getBytes()),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.users.length,4,little:true,signed:true),this.users.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<dynamic> users = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3503927651,4),this.participant.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.users.length,4,little:true,signed:true),this.users.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<dynamic> users = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3985307469,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.events.length,4,little:true,signed:true),this.events.map((x)=>x.getBytes()),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.chats.length,4,little:true,signed:true),this.chats.map((x)=>x.getBytes()),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.users.length,4,little:true,signed:true),this.users.map((x)=>x.getBytes()),].expand((element) => element).toList();}
