...
class SendCode {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2792825935,4),serializeBytes(this.phoneNumber),readBufferFromBigInt(this.apiId,4,little:true,signed:true),serializeBytes(this.apiHash),this.settings.getBytes(),].expand((element) => element).toList();}
...
class CheckPassword {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3515567382,4),this.password.getBytes(),].expand((element) => element).toList();}
...
List<BigInt> exceptAuthKeys = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(2387124616,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.exceptAuthKeys.length,4,little:true,signed:true),this.exceptAuthKeys.map((x)=>readBufferFromBigInt(x,8,little:true,signed:true)),].expand((element) => element).toList();}
