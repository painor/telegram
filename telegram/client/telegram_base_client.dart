...
class TelegramBaseClient {
  ...
  TelegramBaseClient(session, this.apiId, this.apiHash, client_params,
  ...
  connect() async {
    ...
    this.session.setAuthKey(this.sender!.authKey, null);
    await this.sender!.send(this._initWith(
          new GetConfig(),
        ));
