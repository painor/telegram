...
class GetBroadcastStats {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3861908922,4),[0,0,0,0],this.channel.getBytes(),readBufferFromBigInt(this.tzOffset,4,little:true,signed:true),].expand((element) => element).toList();}
...
class LoadAsyncGraph {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1646092192,4),[0,0,0,0],serializeBytes(this.token),(this.x==null||this.x==false)?[]:[readBufferFromBigInt(this.x,8,little:true,signed:true)],].expand((element) => element).toList();}
