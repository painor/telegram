...
List<dynamic> contacts = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(746589157,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.contacts.length,4,little:true,signed:true),this.contacts.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<dynamic> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(157945344,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
List<String> phones = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(269745566,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.phones.length,4,little:true,signed:true),this.phones.map((x)=>serializeBytes(x)),].expand((element) => element).toList();}
...
class Block {
	...
	List<int> getBytes(){return [readBufferFromBigInt(858475004,4),this.id.getBytes(),].expand((element) => element).toList();}
...
class Unblock {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3846242493,4),this.id.getBytes(),].expand((element) => element).toList();}
...
class ResetTopPeerRating {
	...
	List<int> getBytes(){return [readBufferFromBigInt(451113900,4),this.category.getBytes(),this.peer.getBytes(),].expand((element) => element).toList();}
...
class AddContact {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3908330448,4),[0,0,0,0],this.id.getBytes(),serializeBytes(this.firstName),serializeBytes(this.lastName),serializeBytes(this.phone),].expand((element) => element).toList();}
...
class AcceptContact {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4164002319,4),this.id.getBytes(),].expand((element) => element).toList();}
...
class GetLocated {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3544759364,4),[0,0,0,0],this.geoPoint.getBytes(),(this.selfExpires==null||this.selfExpires==false)?[]:[readBufferFromBigInt(this.selfExpires,4,little:true,signed:true)],].expand((element) => element).toList();}
