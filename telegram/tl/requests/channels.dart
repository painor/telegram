...
class ReadHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3423619383,4),this.channel.getBytes(),readBufferFromBigInt(this.maxId,4,little:true,signed:true),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(2227305806,4),this.channel.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class DeleteUserHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3507345179,4),this.channel.getBytes(),this.userId.getBytes(),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(4261967888,4),this.channel.getBytes(),this.userId.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
List<dynamic> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(2911672867,4),this.channel.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class GetParticipants {
	...
	List<int> getBytes(){return [readBufferFromBigInt(306054633,4),this.channel.getBytes(),this.filter.getBytes(),readBufferFromBigInt(this.offset,4,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),readBufferFromBigInt(this.hash,4,little:true,signed:true),].expand((element) => element).toList();}
...
class GetParticipant {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1416484774,4),this.channel.getBytes(),this.userId.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(176122811,4),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class GetFullChannel {
	...
	List<int> getBytes(){return [readBufferFromBigInt(141781513,4),this.channel.getBytes(),].expand((element) => element).toList();}
...
class CreateChannel {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1029681423,4),[0,0,0,0],serializeBytes(this.title),serializeBytes(this.about),(this.geoPoint==null||this.geoPoint==false)?[]:[this.geoPoint.getBytes()],(this.address==null||this.address==false)?[]:[serializeBytes(this.address)],].expand((element) => element).toList();}
...
class EditAdmin {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3543959810,4),this.channel.getBytes(),this.userId.getBytes(),this.adminRights.getBytes(),serializeBytes(this.rank),].expand((element) => element).toList();}
...
class EditTitle {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1450044624,4),this.channel.getBytes(),serializeBytes(this.title),].expand((element) => element).toList();}
...
class EditPhoto {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4046346185,4),this.channel.getBytes(),this.photo.getBytes(),].expand((element) => element).toList();}
...
class CheckUsername {
	...
	List<int> getBytes(){return [readBufferFromBigInt(283557164,4),this.channel.getBytes(),serializeBytes(this.username),].expand((element) => element).toList();}
...
class UpdateUsername {
	...
	List<int> getBytes(){return [readBufferFromBigInt(890549214,4),this.channel.getBytes(),serializeBytes(this.username),].expand((element) => element).toList();}
...
class JoinChannel {
	...
	List<int> getBytes(){return [readBufferFromBigInt(615851205,4),this.channel.getBytes(),].expand((element) => element).toList();}
...
class LeaveChannel {
	...
	List<int> getBytes(){return [readBufferFromBigInt(4164332181,4),this.channel.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> users = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(429865580,4),this.channel.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.users.length,4,little:true,signed:true),this.users.map((x)=>x.getBytes()),].expand((element) => element).toList();}
...
class DeleteChannel {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3222347747,4),this.channel.getBytes(),].expand((element) => element).toList();}
...
class ExportMessageLink {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3468128611,4),this.channel.getBytes(),readBufferFromBigInt(this.id,4,little:true,signed:true),this.grouped ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class ToggleSignatures {
	...
	List<int> getBytes(){return [readBufferFromBigInt(527021574,4),this.channel.getBytes(),this.enabled ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class EditBanned {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1920559378,4),this.channel.getBytes(),this.userId.getBytes(),this.bannedRights.getBytes(),].expand((element) => element).toList();}
...
List<dynamic> admins = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(870184064,4),[0,0,0,0],this.channel.getBytes(),serializeBytes(this.q),(this.eventsFilter==null||this.eventsFilter==false)?[]:[this.eventsFilter.getBytes()],(this.admins==null||this.admins==false)?[]:[readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.admins.length,4,little:true,signed:true),this.admins.map((x)=>x.getBytes())],readBufferFromBigInt(this.maxId,8,little:true,signed:true),readBufferFromBigInt(this.minId,8,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),].expand((element) => element).toList();}
...
class SetStickers {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3935085817,4),this.channel.getBytes(),this.stickerset.getBytes(),].expand((element) => element).toList();}
...
List<int> id = [];len = reader.readInt();
	...
	List<int> getBytes(){return [readBufferFromBigInt(3937786936,4),this.channel.getBytes(),readBufferFromBigInt(0x15c4b51c,4),readBufferFromBigInt(this.id.length,4,little:true,signed:true),this.id.map((x)=>readBufferFromBigInt(x,4,little:true,signed:true)),].expand((element) => element).toList();}
...
class DeleteHistory {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2939592002,4),this.channel.getBytes(),readBufferFromBigInt(this.maxId,4,little:true,signed:true),].expand((element) => element).toList();}
...
class TogglePreHistoryHidden {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3938171212,4),this.channel.getBytes(),this.enabled ? 0xb5757299 : 0x379779bc,].expand((element) => element).toList();}
...
class SetDiscussionGroup {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1079520178,4),this.broadcast.getBytes(),this.group.getBytes(),].expand((element) => element).toList();}
...
class EditCreator {
	...
	List<int> getBytes(){return [readBufferFromBigInt(2402864415,4),this.channel.getBytes(),this.userId.getBytes(),this.password.getBytes(),].expand((element) => element).toList();}
...
class EditLocation {
	...
	List<int> getBytes(){return [readBufferFromBigInt(1491484525,4),this.channel.getBytes(),this.geoPoint.getBytes(),serializeBytes(this.address),].expand((element) => element).toList();}
...
class ToggleSlowMode {
	...
	List<int> getBytes(){return [readBufferFromBigInt(3990134512,4),this.channel.getBytes(),readBufferFromBigInt(this.seconds,4,little:true,signed:true),].expand((element) => element).toList();}
