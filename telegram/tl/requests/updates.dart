...
class GetChannelDifference {
	...
	List<int> getBytes(){return [readBufferFromBigInt(51854712,4),[0,0,0,0],this.channel.getBytes(),this.filter.getBytes(),readBufferFromBigInt(this.pts,4,little:true,signed:true),readBufferFromBigInt(this.limit,4,little:true,signed:true),].expand((element) => element).toList();}
